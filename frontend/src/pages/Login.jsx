  ...
  return (
    <div style={{ minHeight:'100vh', background:'#f1f5f9', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ background:'white', padding:32, borderRadius:12, width:380, boxShadow:'0 4px 20px rgba(0,0,0,0.1)' }}>
        <h2 style={{ textAlign:'center', marginBottom:24, color:'#000000', fontWeight:800 }}>🏦 NeoBank {isReg ? 'Register' : 'Login'}</h2>
        {isReg && <>
        ...
        <p style={{ textAlign:'center', cursor:'pointer', color:'#000000', fontSize:13, marginTop:12, fontWeight:700, textDecoration:'underline' }}
...
const btn = { width:'100%', padding:12, background:'#000000', color:'white', border:'none', borderRadius:6, cursor:'pointer', fontSize:15, fontWeight:'bold' };