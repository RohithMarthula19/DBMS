  ...
  return (
    <div style={{ fontFamily:'sans-serif', background:'#f8fafc', minHeight:'100vh' }}>
      ...
      <div style={{ padding:24, maxWidth:1200, margin:'0 auto' }}>
        <h2 style={{ color:'#000000' }}>📊 Analytics Dashboard</h2>

        <div style={{ marginBottom:20 }}>
          <label style={{ fontWeight:600, marginRight:10, color:'#000000' }}>Account:</label>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20, marginBottom:20 }}>
          ...
          <div style={card}>
            <h3 style={{ margin:'0 0 12px', color:'#000000' }}>This Month by Category</h3>
          ...
          {/* Forecast */}
          <div style={card}>
            <h3 style={{ margin:'0 0 12px', color:'#000000' }}>Month-End Forecast</h3>
            <table style={{ width:'100%', fontSize:13, borderCollapse:'collapse' }}>
              ...
              <tbody>
                ...
                {!forecast.length && <tr><td colSpan={4} style={{ padding:12, color:'#000000', textAlign:'center' }}>No forecast data</td></tr>}
              </tbody>
            </table>
          </div>
          ...
          <div style={card}>
            <h3 style={{ margin:'0 0 12px', color:'#000000' }}>Rolling 7-Day Avg Spend</h3>
          ...
          {/* Percentile rank */}
          <div style={card}>
            <h3 style={{ margin:'0 0 12px', color:'#000000' }}>Monthly Spend Percentile Rank</h3>
            <ResponsiveContainer width="100%" height={200}>
            ...
            <p style={{ fontSize:11, color:'#000000', marginTop:8 }}>Higher = you spent more that month compared to your own history</p>
          </div>
        </div>

        {/* Audit Trail */}
        <div style={card}>
          <h3 style={{ margin:'0 0 16px', color:'#000000' }}>🔍 Regulatory Audit Trail (Last 90 Days)</h3>
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:12 }}>
            ...
            <tbody>
              ...
              {!auditTrail.length && <tr><td colSpan={5} style={{ padding:24, textAlign:'center', color:'#000000' }}>No audit events in last 90 days</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
